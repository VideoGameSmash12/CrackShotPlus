 ...
 {
   private static final Map<String, String[]> sounds = (Map)new HashMap<String, String>();
   ...
   public static Sound get(String name) throws IllegalArgumentException {
     try {
       ...
       if (otherNames != null) {
         byte b; int i; String[] arrayOfString; for (i = (arrayOfString = otherNames).length, b = 0; b < i; ) { String otherName = arrayOfString[b];
           try {
...
/* Location:              /home/videogamesm12/Downloads/CrackShot.jar!/com/shampaggon/crackshot/SoundManager.class
